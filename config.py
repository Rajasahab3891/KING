...
BOT_USERNAME = getenv("BOT_USERNAME" , "KingBot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME" , "PANDA BABY")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME" , "PANDAXBABY")
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/rajasahab3891/King",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "King")
GIT_TOKEN = getenv(
    "GIT_TOKEN", None
